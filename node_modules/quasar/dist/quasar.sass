...
$inset-shadow         : 0 7px 9px -7px var(--q-shadow-inset) inset !default
$inset-shadow-down    : 0 -7px 9px -7px var(--q-shadow-inset) inset !default
$elevation-umbra      : var(--q-shadow-umbra) !default
$elevation-penumbra   : var(--q-shadow-penumbra) !default
$elevation-ambient    : var(--q-shadow-ambient) !default
...
$inset-dark-shadow         : 0 7px 9px -7px var(--q-dark-shadow-inset) inset !default
$inset-dark-shadow-down    : 0 -7px 9px -7px var(--q-dark-shadow-inset) inset !default
$elevation-dark-umbra      : var(--q-dark-shadow-umbra) !default
$elevation-dark-penumbra   : var(--q-dark-shadow-penumbra) !default
$elevation-dark-ambient    : var(--q-dark-shadow-ambient) !default
...
$layout-shadow                            : 0 0 10px 2px var(--q-shadow-umbra), 0 0px 10px var(--q-shadow-layout) !default
$layout-shadow-dark                       : 0 0 10px 2px var(--q-dark-shadow-umbra), 0 0px 10px var(--q-dark-shadow-layout) !default
$layout-marginal-background               : var(--q-primary) !default
$layout-marginal-color                    : #fff !default
...
.q-expansion-item
  ...
  &__toggle-section--switched.q-item__section--side
    min-width: 56px
  .q-item__section--main ~ &__icon-section
    min-width: 0
  &--standard
...
.q-field
  ...
  &__bottom
    ...
    min-height: $field-with-bottom-padding-bottom
  ...
  &__messages
    line-height: 1
    &--animated
      animation: q-field-message .6s cubic-bezier(.86,0,.07,1)
    > div
      word-break: break-word
      word-wrap: break-word
...
.q-layout__section--marginal
  background-color: $layout-marginal-background
  color: $layout-marginal-color
.q-header
  &--hidden
...
@keyframes q-linear-progress--indeterminate-short
  0%
    transform: translateX(-101%) scale(1)
  60%
    transform: translateX(107%) scaleX(.01)
  100%
    transform: translateX(107%) scaleX(.01)
.q-menu
...
.q-slider
  ...
  &--focus
    ...
    .q-slider__selection
      opacity: 1
  @media (any-hover: hover)
    &.q-slider--editable .q-slider__track-container:hover
      .q-slider__focus-ring
        background: currentColor
        transform: scale(1.55)
        opacity: .25
  ...
  @media (any-hover: hover)
    &.q-slider--enabled .q-slider__track-container:hover
      .q-slider__pin
        opacity: 1
  &--label
    &.q-slider--active,
...
.q-spinner-dots circle
  animation: q-dots-pulse .8s linear infinite
...
@keyframes q-infinity-dash
  0%
    stroke-dashoffset: 0 #{"/* rtl:ignore */"}
  100%
    stroke-dashoffset: 21.382410685221355 #{"/* rtl:ignore */"}
.q-spinner-ios line
...
.q-spinner-puff circle
  animation: q-puff-expand 1.8s cubic-bezier(.165, .84, .44, 1) infinite, q-puff-fade 1.8s cubic-bezier(.3, .61, .355, 1) infinite
...
.q-stepper
  ...
  &__step-inner--horizontal
    padding: 24px
  &__step-inner--vertical
    padding: 0 24px 32px 60px
  
  
  
  &__step-content--leaving
    top: 0
    left: 0
  &__tab--horizontal
    overflow: hidden
    ...
    &:last-child
      border-top-right-radius: inherit
    &:first-child .q-stepper__dot:before,
    &:last-child .q-stepper__label:after,
    &:last-child .q-stepper__dot:after
      display: none
    .q-stepper__line
      contain: layout
      &:before, &:after
  ...
  &__step--vertical
    overflow: hidden
    &:first-child > .q-stepper__tab .q-stepper__dot:before,
    &:last-child > .q-stepper__tab .q-stepper__dot:after
      display: none
    &:last-child > .q-stepper__step-content > .q-stepper__step-inner
      padding-bottom: 8px
  &--dark
    &.q-stepper--bordered,
...
.q-tree
  ...
  &--no-connectors
    ...
    .q-tree__vguide:before,
    .q-tree__vguide:after
  ...
  &__vguide
    ...
    &--connector:after
      ...
      border-left: 1px solid currentColor
      border-bottom: 1px solid currentColor
  &__vnode--parent .q-tree__vguide--connector:after
    right: -2px
  &--virtual
    .q-tree__node-header
      flex: 1 1 0%
    ...
    .q-tree__node-body
      flex: 1 1 0%
      min-width: 0
    .q-tree__vnode--parent .q-tree__node-header
      padding-left: 6px
    .q-tree__vnode--parent .q-tree__node-body
      padding-left: 27px
    .q-tree__vnode--child .q-tree__node-header
      padding-left: 26px
    .q-tree__vnode--root.q-tree__vnode--parent .q-tree__node-header
      padding-left: 4px
    .q-tree__vnode--root.q-tree__vnode--child .q-tree__node-header
      padding-left: 24px
  &--dense
    > .q-tree__node--child > .q-tree__node-header
      padding-left: 1px
...
.q-ripple
  ...
  &__inner
    ...
    &--leave
      ...
      transition: transform .225s cubic-bezier(.4, 0, .2, 1), opacity .25s cubic-bezier(.4, 0, .2, 1)
.q-morph--invisible,
.q-morph--internal
  opacity: 0 !important
...
\:root
  ...
  --q-shadow-color:      #{$shadow-color}
  --q-dark-shadow-color: #{$dark-shadow-color}
body
...
body.electron
  ...
  .q-menu, .q-dialog__inner > *, .q-notification, .q-tooltip
